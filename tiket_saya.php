...
// Ini adalah query yang canggih untuk menggabungkan 4 tabel
try {
    $sql = "SELECT
                p.id_pemesanan,
                p.tanggal_pemesanan,
        ...
        <div class="pesanan-card">
            ...
            <div class="pesanan-body">
                <div class="pesanan-detail">
                    ...
                    <p><strong>Rincian Tiket:</strong><br><?php echo $pesanan['rincian_tiket']; // Sudah aman, tidak perlu htmlspecialchars ?></p>
                ...
                <div class="pesanan-aksi">
                    ...
                    <?php elseif ($pesanan['status_pembayaran'] == 'Lunas'): ?>
                        ...
                        <p style="font-size: 0.9em; color: #155724;">Tiket Anda sudah dikonfirmasi. (Di sini nanti bisa ditambahkan link "Download E-Tiket").</p>
                        
                    <?php elseif (!empty($pesanan['bukti_pembayaran'])): ?>
                         <h4>Menunggu Validasi Admin</h4>
                         <p style="font-size: 0.9em; color: #007bff;">Anda sudah mengupload bukti bayar. Admin akan segera memverifikasinya.</p>
